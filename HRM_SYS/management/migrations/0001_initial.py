    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departments', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='management.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sent', models.DateTimeField(default=datetime.datetime(2023, 10, 25, 9, 7, 17, 411856, tzinfo=datetime.timezone.utc))),
                ('seen', models.BooleanField(default=False)),
