    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.TimeField(default=datetime.datetime(2023, 11, 23, 14, 23, 48, 356388, tzinfo=datetime.timezone.utc))),
                ('end', models.TimeField(default=datetime.datetime(2023, 11, 23, 14, 23, 48, 356388, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='management.station')),
            ],
        ),
        migrations.CreateModel(
            name='EmpFiles',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sent', models.DateTimeField(default=datetime.datetime(2023, 11, 23, 14, 23, 48, 356388, tzinfo=datetime.timezone.utc))),
                ('seen', models.BooleanField(default=False)),
